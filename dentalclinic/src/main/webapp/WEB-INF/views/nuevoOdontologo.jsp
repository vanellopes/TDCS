...
<head>
  ...
  <title>DentalClinic | Nuevo Profesional</title>
...
<div class="wrapper">
	...
	<div class="content-wrapper">
				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">Nuevo profesional</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<form id="frmIngreso" name="input" action="nuevo-odontologo" method="post">
				<div class="row">
					<div class="col-md-6">
						<div class="card card-primary">
							...
							<div class="form-group">
							    ...
							    <div class="form-group">
							          <!-- Text input-->
							          <label class="control-label" for="input01" style="float:left;width:140px">Matricula</label>
							          <div class="controls">
				...
				<div class="row">
					<div class="col-12">
						...
						<input type="submit" value="Crear nuevo profesional" class="btn btn-success ">
					</div>
				</div>
				</form>
		</section>
